...
export function Hero() {
  return (
    <div className="w-full flex flex-col-reverse lg:flex-row h-auto lg:h-screen items-center justify-around gap-7  px-4 py-10">
      <div className="w-full lg:w-1/2 space-y-6 px-4 sm:px-6 text-center lg:text-left">
        <h1 className="font-semibold text-white text-3xl sm:text-4xl lg:text-5xl leading-snug">
          Olá, Eu sou <br />
        ...
        <div className="space-y-4 text-white text-base sm:text-lg lg:text-xl leading-relaxed">
          <p>
        ...
        <div className="flex flex-col items-center lg:items-start gap-6 mt-6">
          ...
          <div className="flex gap-4 justify-center lg:justify-start">
            <Link
              ...
              target="_blank"
            >
              <Linkedin className="w-10 h-10 sm:w-[50px] sm:h-[50px] text-white border-2 border-white rounded-full p-2 hover:bg-blue-100 hover:text-black transition" />
            </Link>

            <Link href="https://github.com/NicollasMDs7" target="_blank">
              <Github className="w-10 h-10 sm:w-[50px] sm:h-[50px] text-white border-2 border-white rounded-full p-2 hover:bg-blue-100 hover:text-black transition" />
            </Link>
            ...
            <Link
              ...
              target="_blank"
            >
              <Instagram className="w-10 h-10 sm:w-[50px] sm:h-[50px] text-white border-2 border-white rounded-full p-2 hover:bg-blue-100 hover:text-black transition" />
            </Link>
          </div>
          ...
          >
            <Button className="w-[160px] h-[50px] text-white border-2 border-white rounded-full hover:bg-white hover:text-black transition">
